var app = angular.module('BasicApp',['BasicApp.services','angularjs-datetime-picker']);
	// ,"mightyDatepicker"
...
// app.controller('ListCtrl', function($scope, filterService) { $scope.filterService = filterService;
// $scope.teamsList = [{
